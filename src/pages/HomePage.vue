...
<style lang="scss">
  ...
  .intro {
    background: #cfcfaa;  /* fallback for old browsers */
        background: -webkit-linear-gradient(to bottom, #f5f5f5, #b7b77d);  /* Chrome 10-25, Safari 5.1-6 */
        background: linear-gradient(to bottom, #f5f5f5, #b7b77d); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
  }
